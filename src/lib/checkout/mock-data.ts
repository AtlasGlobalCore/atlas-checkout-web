...
export const mockCheckoutSession: CheckoutSession = {
  ...
  methods: [
    {
      id: "mp_card",
      method_type: "STRIPE_ELEMENTS",
      provider: "MP_001",
      label: "Cartão de Crédito",
      description: "Visa, Mastercard, Amex — até 12x sem juros",
      icon: "CreditCard",
      enabled: true,
      config: {
    ...
    {
      id: "viva_modal",
      method_type: "VIVA_MODAL",
      provider: "VIVA_001",
      label: "Viva Wallet",
      description: "Cartão ou multibanco",
      icon: "Wallet",
      enabled: true,
    },
    {
      id: "sepa_instant",
      method_type: "SEPA_INSTANT",
      provider: "SEPA_001",
      label: "Transferência SEPA",
      description: "IBAN instantâneo",
      icon: "Landmark",
      enabled: true,
    },
    {
      id: "mbway_flow",
      method_type: "MBWAY_FLOW",
      provider: "MBWAY_001",
      label: "MB WAY",
